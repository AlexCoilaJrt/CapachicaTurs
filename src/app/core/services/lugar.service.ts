...
export class LugaresService {
  ...
  /**
   * Permite buscar lugares con filtros dinámicos.
   * Recibe un objeto con claves y valores para filtrar (nombre, lugar, fecha, etc.).
   */
  ...
  buscarLugares(filtros: FiltrosBusqueda): Observable<any[]> {
    let params = new HttpParams();
    if (filtros.nombre) {
